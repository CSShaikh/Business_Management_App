...
class AddSupplierScreen extends StatefulWidget {
  ...
  const AddSupplierScreen({super.key, required this.businessId, this.supplier});
...
class _AddSupplierScreenState extends State<AddSupplierScreen> {
  ...
  void initState() {
    ...
    final SupplierModel? supplier = widget.supplier;
  ...
  Future<void> _saveSupplier() async {
    ...
    try {
      ...
      final SupplierModel? existingSupplier = widget.supplier;

      if (_isEditMode && existingSupplier != null) {
            ...
            builder: (context, constraints) {
              ...
              return SingleChildScrollView(
                padding: EdgeInsets.fromLTRB(
                  constraints.maxWidth < 420 ? 12 : 20,
                  20,
                  constraints.maxWidth < 420 ? 12 : 20,
                  110,
                ),
                  ...
                  child: ConstrainedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildBasicInformationCard(theme, wide),
                        const SizedBox(height: 16),
                        _buildContactCard(theme, wide),
                        const SizedBox(height: 16),
                        _buildBusinessDetailsCard(theme),
                        const SizedBox(height: 16),
  ...
  Widget _buildPageHeader(ThemeData theme) {
    return Column(
      ...
      children: [
        Text(
          _isEditMode ? 'Update Supplier' : 'Create New Supplier',
  ...
  Widget _buildBasicInformationCard(ThemeData theme, bool wide) {
    return _sectionCard(
      theme,
  ...
  Widget _buildContactCard(ThemeData theme, bool wide) {
    return _sectionCard(
      theme,
  ...
  Widget _buildBusinessDetailsCard(ThemeData theme) {
    return _sectionCard(
      theme,
  ...
  Widget _buildNotesCard(ThemeData theme) {
    return _sectionCard(
      ...
      child: _textField(
        ...
        hint: 'Add any additional supplier notes',
        icon: Icons.notes_outlined,
        maxLines: 4,
        textCapitalization: TextCapitalization.sentences,
      ),
    ...
    return SizedBox(
      ...
      child: FilledButton.icon(
        ...
        icon: _saving
            ...
            : Icon(_isEditMode ? Icons.save_outlined : Icons.add_rounded),
        label: Text(
          _saving
              ? 'Saving...'
              : _isEditMode
  ...
  String? _validateEmail(String? value) {
    ...
    final bool valid = RegExp(r'^[^@\s]+@[^@\s]+\.[^@\s]+$').hasMatch(text);
  ...
  String? _validateGst(String? value) {
    ...
    final bool valid = RegExp(r'^[0-9A-Z]{15}$').hasMatch(normalized);
